...
public class BackgroundControl_0 : MonoBehaviour
{
    ...
    void Update() {
        ...
        //if (Input.GetKeyDown(KeyCode.RightArrow)) NextBG(); //Input System Package not supported in this project
        //if (Input.GetKeyDown(KeyCode.LeftArrow)) BackBG(); //Input System Package not supported in this project
    }
